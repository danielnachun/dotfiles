...
if patched_font_in_use; then
    ...
    TMUX_POWERLINE_LEFT_END=""
	TMUX_POWERLINE_SEPARATOR_LEFT_THIN=""
	TMUX_POWERLINE_SEPARATOR_RIGHT_BOLD=""
    TMUX_POWERLINE_RIGHT_END=""
...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR:-'#fafafa'}
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-'#383a42'}
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
        "powerline_left_end #fafafa #50a14f ${TMUX_POWERLINE_SEPARATOR_THIN} #50a14f #50a14f right_disable"
		"tmux_session_info #50a14f #383a42,bold ${TMUX_POWERLINE_SEPARATOR_RIGHT_BOLD} #fafafa #50a14f left_disable"
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		#"xkb_layout 125 117"
		# "date_day 235 136"
		"mode_indicator #e5e5e6  #383a42 ${TMUX_POWERLINE_SEPARATOR_LEFT_BOLD} #fafafa #e5e5e6"
        # "date #e5e5e6  #383a42 ${TMUX_POWERLINE_SEPARATOR_LEFT_BOLD} #fafafa #e5e5e6"
        # "time #e5e5e6  #383a42 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN} "
        "hostname #50a14f #383a42,bold ${TMUX_POWERLINE_SEPARATOR_LEFT_BOLD} #e5e5e6 #50a14f right_disable"
        "powerline_right_end #fafafa #50a14f ${TMUX_POWERLINE_SEPARATOR_THIN} #50a14f #50a14f left_disable"
