...
return {
	...
	opts = function(_, opts)
		...
		opts.formatters_by_ft.c =
			vim.tbl_extend("force", opts.formatters_by_ft.c, { "astyle", "clang-format", "indent", "uncrustify" })
		...
		opts.formatters_by_ft.cpp =
			vim.tbl_extend("force", opts.formatters_by_ft.cpp, { "astyle", "clang-format", "uncrustify" })
		opts.formatters_by_ft.cs =
			vim.tbl_extend("force", opts.formatters_by_ft.cs, { "astyle", "clang-format", "uncrustify" })
		opts.formatters_by_ft.d = vim.tbl_extend("force", opts.formatters_by_ft.d, { "dfmt" })
		opts.formatters_by_ft.fortran =
			vim.tbl_extend("force", opts.formatters_by_ft.fortran, { "findent", "fprettify" })
		...
		opts.formatters_by_ft.haskell =
			vim.tbl_extend("force", opts.formatters_by_ft.haskell, { "hindent", "stylish-haskell" })
		...
		opts.formatters_by_ft.markdown =
			vim.tbl_extend("force", opts.formatters_by_ft.markdown, { "cbfmt", "mdformat", "mdsf", "textlint" })
		opts.formatters_by_ft.ocaml =
			vim.tbl_extend("force", opts.formatters_by_ft.ocaml, { "ocamlformat", "ocp-indent" })
		...
		opts.formatters_by_ft.xml =
			vim.tbl_extend("force", opts.formatters_by_ft.xml, { "tidy", "xmlformat", "xmllint" })
